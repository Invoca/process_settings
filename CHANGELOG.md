...
## [0.14.1] - 2020-08-24
### Fixed
- Fixed bug with listen gem sometimes hanging (and therefore not noticing changes to combined_process_settings.yml) by requiring
  listen v3.2.1.invoca.3.
...
[0.14.1]: https://github.com/Invoca/process_settings/compare/v0.14.0...v0.14.1
